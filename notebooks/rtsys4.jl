...
# ╔═╡ ebc49360-79c6-4341-b8a7-0c473302987d
begin
	using PlutoUI
	using Plots
...
# ╔═╡ 6766dd31-e6a3-42aa-b4e1-b5adffeeb38a
using LinearAlgebra

# ╔═╡ 0d312a07-b156-4893-b331-67c7cbabe2cd
md"# Aufgabe 1"

# ╔═╡ cae8e89b-8732-42ae-a3da-534dd2a7b08a
md"**Zustandsraumdarstellung**"

# ╔═╡ ef7126b2-f3ca-11ec-31e2-dd6beeb8e1ff
A, b, c, d = 1, 5, 2, 0

# ╔═╡ 47513f25-cbdb-49c0-8c92-77418bb0feff
sys = ss(A, b, c, d)

# ╔═╡ 6b2f5ea0-e2c4-403c-b584-2c6c42d5a7d0
md"## Aufgabe 1.1"

# ╔═╡ b17a9015-0893-45d9-995d-4c905938da69
begin
	plot(step(sys, 1), ylim=(-1, 30), label="Sprungantwort")
	plot!(impulse(sys, 1), ylim=(-1, 30), label="Spoßantwort")
end

# ╔═╡ 614271d2-0d64-445f-9247-2b258393bf17
md"Das System ist nicht BIBO-stabil."

# ╔═╡ 9c34aaf6-981b-4b92-9df2-9f5e8f393e00
md"## Aufgabe 1.2"

# ╔═╡ 30d528ef-d00a-4ee0-8758-53644a51a69c
md"**Zustandsregler**"

# ╔═╡ d8985e31-8730-4671-bccd-d351b0d2a275
md"""
Rückführung R: $(@bind R Slider(0.1:0.1:2, default=0.7))

Vorfilter V: $(@bind V Slider(0.05:0.05:1, default=0.5))
"""

# ╔═╡ 632fc833-4872-4a3d-9e5b-cefc7fe3d670
R, V

# ╔═╡ 9fe80dc7-0b5c-462d-82ed-a528f49363f3
λ_RV = 1 - 5R

# ╔═╡ b5f47bf1-7891-4508-bdc3-926018214522
md"Das System hat den Eigenwert λ = $λ_RV"

# ╔═╡ 7ebf1417-7ac6-4518-b081-8752791f5c39
md"Geschlossener Regelkreis mit Zustandsregler:"

# ╔═╡ e6847e74-4297-48af-bc32-2627f512c708
sys_RV = ss(A - b * R, V * b, c, d)

# ╔═╡ f2fd8de1-bf25-4a0e-a3c9-3aea7134ac92
let
	res = step(sys_RV, 5)
...
# ╔═╡ 946a9fc4-b193-41b1-9be9-f87d01d27631
md"**Zustandsregler mit Eigenwertvorgabe:**"

# ╔═╡ 8c1b1fe7-7c23-44d3-a3a8-4e719412bb0f
md"λ: $(@bind λ Slider(-3:0.1:-0.1, default=-1))"

# ╔═╡ 7a6aeaf4-4f48-4861-9c16-d97bfd00c3f4
λ

# ╔═╡ 86b0a229-3a3e-40e2-85fa-102e4166a5ad
md"Berechne Rückführung R und Vorfilter V, so dass Gesamtsystem λ als Eigenwert hat und asymptotisch stabil ist."

# ╔═╡ 5fcddf47-e4c6-40d2-a433-b72bb5073cb8
R_λ = (1 - λ) / 5

# ╔═╡ 22fa4eaf-924f-4fa8-8475-75142276e83a
V_λ = - λ / 10

# ╔═╡ b7b9133a-fb97-404e-a993-1d221f299a43
md"Geschlossener Regelkreis mit Zustandsregler und vorgegebenem Eigenwert:"

# ╔═╡ 2e241195-09c2-4f7b-80fb-abc64a7e6882
sys_λ = ss(A - b * R_λ, V_λ * b, c, d)

# ╔═╡ 6a0a5d62-546e-4af4-8762-41366c84a50a
let
	res = step(sys_λ, 5)
	plot(res, label="y(t)", ylim=(-0.5, 2.5))
...
# ╔═╡ 15c08fb1-2e04-4f48-b5e6-95d2aee5b631
md"## Aufgabe 1.3"

# ╔═╡ 35953e8e-a40b-4bcd-bc12-86563e429ee2
md"**P-Regler**"

# ╔═╡ ff0d8bed-a000-4a90-9db7-28bdac8fde52
md"Verstärkung K: $(@bind K Slider(0.05:0.05:2, default=0.5))"

# ╔═╡ b0730787-5e5c-44ac-91d3-09367b3c15dc
K

# ╔═╡ 749eefe9-f9fb-46f7-a4bd-83b1ae28fd50
λ_P = 1 - 10K

# ╔═╡ 148ab395-66c4-4d3e-81d8-2eb3f783ec6f
md"Geschlossener Regelkreis mit P-Regler:"

# ╔═╡ d4f513da-25f2-4c98-9a97-d689bf27b863
sys_P = ss(A - K * b * c, K * b, c, d)

# ╔═╡ efb2af9d-aaf1-4eed-8c62-0af566a0514d
let
	res = step(sys_P, 5)
...
# ╔═╡ c5e19b58-25b8-4f8f-8394-0bb1617e5eda
md"# Aufgabe 2"

# ╔═╡ c618839e-2c69-40cb-be51-29e2d0942e87
A2 = [ 0  1  0
	   0  0  1
	  -7 -3 -2]

# ╔═╡ 2cf583e2-8846-479a-9757-581bad70022a
eigvals(A2)
...
git-tree-sha1 = "0f554442db237ca95fda416d0b72d7bb58d27e54"
...
git-tree-sha1 = "5d1c61ae6b136e8125b86c6bec1044fdb6ba8da0"
